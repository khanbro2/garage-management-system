                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($garage->currentSubscription)
                                        <span class="badge bg-success">{{ $garage->currentSubscription->plan->name }}</span>
                                        <br>
                                        <small class="text-muted">
                                            Expires:
                                            {{ $garage->currentSubscription->ends_at?->format('d/m/Y') ?? 'Never' }}
                                        </small>
                                    @else
                                ...
                                <td>
                                    {{-- Use the method isActive() instead of the property is_active --}}
                                    @if ($garage->isActive())
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('superadmin.garages.show', $garage) }}"
                                            class="btn btn-outline-primary" title="View">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        <a href="{{ route('superadmin.garages.edit', $garage) }}"
                                            class="btn btn-outline-warning" title="Edit">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ route('superadmin.garages.destroy', $garage) }}" method="POST"
                                            class="d-inline"
                                            onsubmit="return confirm('Are you sure? This will delete all garage data.');">
                                            @csrf
                                            @method('DELETE')
